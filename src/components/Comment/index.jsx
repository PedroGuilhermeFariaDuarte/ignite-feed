...
export function Comment({ commentary, indexComment, setHot, removeCommentary }){
            ...
            <div className={styles.commentContainer}>
                <div className={styles.commentContent}>
                    <div className={styles.commentHeader}>
                        ...
                        <button title="Deletar comentário" onClick={() => removeCommentary(indexComment)}>
                ...
                <div className={styles.commentReactions}>
                    <button title="Dar um hot" onClick={() => setHot(indexComment)}>
